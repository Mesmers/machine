...
public class FoldableLayout extends RelativeLayout {
    ...
    private void setupView(Context context) {
        ...
        mRootView = LayoutInflater.from(context).inflate(worldline.com.foldablelayout.R.layout.foldable_layout, this, true);
        mContentLayout = (RelativeLayout) findViewById(worldline.com.foldablelayout.R.id.foldable_content_view);
        mImageViewBelow = (ImageView) findViewById(worldline.com.foldablelayout.R.id.foldable_layout_below_bitmap);
        mImageViewAbove = (ImageView) findViewById(worldline.com.foldablelayout.R.id.foldable_layout_above_bitmap);
        mMatrix = new Matrix();
    ...
    public void foldWithAnimation() {
        if (!mIsAnimating) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                belowShadow = getResources().getDrawable(worldline.com.foldablelayout.R.drawable.shadow, null);
                aboveShadow = getResources().getDrawable(worldline.com.foldablelayout.R.drawable.shadow, null);
            } else {
                belowShadow = getResources().getDrawable(worldline.com.foldablelayout.R.drawable.shadow);
                aboveShadow = getResources().getDrawable(worldline.com.foldablelayout.R.drawable.shadow);
            }
