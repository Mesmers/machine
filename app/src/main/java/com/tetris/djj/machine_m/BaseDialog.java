...
public class BaseDialog extends Dialog implements View.OnClickListener {
    ...
    private LinearLayout mLlButton2;// 底部按钮3
    private LinearLayout mLlButton3;// 底部按钮3
    ...
    private void initViews() {
        ...
        mLlButton2 = (LinearLayout) findViewById(R.id.ll_dialog_generic_btn_button2);
        mLlButton3 = (LinearLayout) findViewById(R.id.ll_dialog_generic_btn_button3);
    ...
    public void setButton3(CharSequence text,
        ...
        if (text != null && listener != null) {
            mLayoutBottom.setVisibility(View.VISIBLE);
            mLlButton3.setVisibility(View.VISIBLE);
            mBtnButton3.setText(text);
            mOnClickListener3 = listener;
        } else {
            mLlButton3.setVisibility(View.GONE);
        }
    }
